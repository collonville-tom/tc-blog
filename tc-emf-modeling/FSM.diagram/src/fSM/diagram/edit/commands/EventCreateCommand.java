...
public class EventCreateCommand extends EditElementCommand {
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		fSM.Event newElement = fSM.FSMFactory.eINSTANCE.createEvent();

		fSM.FSM owner = (fSM.FSM) getElementToEdit();
		owner.getEvent().add(newElement);
	...
	* @generated
	*/
	protected void doConfigure(fSM.Event newElement, IProgressMonitor monitor, IAdaptable info)
