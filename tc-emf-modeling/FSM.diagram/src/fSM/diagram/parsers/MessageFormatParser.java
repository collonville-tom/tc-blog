...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(fSM.diagram.part.FSMDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE,
					NLS.bind(fSM.diagram.part.Messages.MessageFormatParser_InvalidInputError,
